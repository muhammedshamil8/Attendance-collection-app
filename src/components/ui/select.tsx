...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-10 w-full items-center justify-between rounded-md border   bg-slate-100 px-3 py-2 text-sm placeholder:text-slate-500 focus:outline-none focus:border-emearlad-400 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1  dark:bg-slate-950  dark:placeholder:text-slate-400   text-black dark:text-white",
      className
    )}
    {...props}
  >
