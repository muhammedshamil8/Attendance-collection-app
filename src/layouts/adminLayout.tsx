        ...
        <AuthRoleRequire role='admin'>
            <div className='bg-zinc-100 dark:bg-slate-900 min-h-screen overflow-auto flex flex-col items-center w-full '>
                ...
                <header className='w-full flex items-center justify-center  py-10 relative'>
                    ...
                    <AlertDialog>
                        <AlertDialogTrigger >
                            <div className='absolute border left-2 top-2 bg-white dark:bg-black rounded-md h-10 w-10 flex items-center justify-center cursor-pointer hover:bg-slate-100 dark:hover:bg-gray-900 outline-none dark:border-gray-800 '>
